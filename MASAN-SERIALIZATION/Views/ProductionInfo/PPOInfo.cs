...
namespace MASAN_SERIALIZATION.Views.ProductionInfo
{
    public partial class PPOInfo : UIPage
    {
        ...
        private bool IsTestModeConfigured => AppConfigs.Current.TestMode;
        private bool IsTestPOActive =>
            IsTestModeConfigured &&
            string.Equals(Globals.ProductionData.orderNo, TestModePOName, StringComparison.OrdinalIgnoreCase);
