...
namespace MASAN_SERIALIZATION.Views.Settings
{
    public partial class PLCSetting : UIPage
    {
        ...
        public PLCSetting()
        {
            ...
            // Khởi tạo BackgroundWorker cho lưu PLC CS
            bgwSavePLCCS = new BackgroundWorker();
            bgwSavePLCCS.DoWork += bgwSavePLCCS_DoWork;
            bgwSavePLCCS.RunWorkerCompleted += bgwSavePLCCS_RunWorkerCompleted;
        ...
        {
            if (!bgwSavePLCCS.IsBusy)
                bgwSavePLCCS.RunWorkerAsync();
        }
